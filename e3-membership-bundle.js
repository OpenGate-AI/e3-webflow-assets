/* e3 membership polish bundle v2 - with DOMContentLoaded wrapper */
(function(){
...
if (document.readyState !== 'loading') { e3mInit(); }
else { document.addEventListener('DOMContentLoaded', e3mInit); }
